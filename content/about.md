...
I'm Riha! You might know me as Hari/Harikrishnan.

I am a part anthropologist, part systems thinker, and full-time translator between people, data, and decisions. My journey in technology is driven by curiosity and a love for solving complex problems with data.
...
In every setting, my goal is the same — to make data human, useful, and quietly powerful.
...
## Areas I work in
    ...
    - Low-code & Automation Workflows (Google Apps Script, Power BI, ODK,
        Monday.com, etc.)
...
## Skills & Technologies
    ...
    - Tools: Git, Hugo, GitHub Actions

## Work With Me

If you want your organization to think in systems, act on evidence, and stay deeply human while doing it — let’s collaborate.

[Email me here](mailto:rawringriha@gmail.com) 

While you are here, feel free to explore my projects, read my writings, or check out my artistic endeavors!
